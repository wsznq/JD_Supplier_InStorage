...
<template>
  <div class="wrap" id="wrap">
    ...
    <div class="searchBox">
      ...
      <div class="title" style="margin-top: 5px">退货单号</div>
      <div class="number">
        <input type="text" placeholder="请输入退货单号" v-model='form.I_ZRETURNSNO'>
      </div>
...
import { JDGetZRETURNS } from "@/api/getData";
const date = new Date
  ...
  methods: {
    async getList() {
      ...
      try {
        ...
        let res = await JDGetZRETURNS(this.form);
        console.log(res);
